...
const UserInfo = ({user, fetchUsers, openEditForm, visibleContextMenu, setVisibleContextMenu, checkBoxHeader}) => {
    ...
    return (
        <div className="user__info">
            ...
            <div className="column__userStatus">
            ...
            <div className="column__paymentStatus">
